...
const CarouselPrevious = React.forwardRef(({ className, ...props }, ref) => {
	...
	return (
		<button
			ref={ref}
			className={cn(
				"absolute z-10 inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-black/45 text-white backdrop-blur transition hover:bg-black/65 disabled:cursor-not-allowed disabled:opacity-40",
				orientation === "horizontal"
